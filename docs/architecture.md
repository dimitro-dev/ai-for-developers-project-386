...
4. Backend заново получает Event Type и настройки.
...
`tasks/task-<task-id>/adr.md` обязателен для каждого task и должен явно подтвердить отсутствие архитектурного влияния либо зафиксировать решение. Особое внимание требуется, если предлагается:
