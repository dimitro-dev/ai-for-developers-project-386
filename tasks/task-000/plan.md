...
| P08 | Нет защиты от generated drift | Проверить: повторный `npm run generate` не создаёт diff; `generate:check` падает при ручной правке generated; format-check проходит | в плане |
| P09 | Команды bootstrap не документированы | README с точными командами установки, генерации, проверок и запуска; финализация `result.md` | в плане |
