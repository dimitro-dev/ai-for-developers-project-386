...
| id | Задача | Зависимости | Стадия |
|---|---|---|---|
| [process/001](process/001-tasks-rework/) | Переработка процесса задач: структура, стадии, CLI | — | реализация (22/23) |
...
| [process/001](process/001-tasks-rework/) | реализация (22/23) | Активная задача: инструмент task, треки full/lite, миграция каталога, растворение ролей | — |
