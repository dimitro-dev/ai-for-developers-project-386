...
| id | Задача | Зависимости | Стадия |
|---|---|---|---|
| [front/owner/001](front/owner/001-owner-screens/) | Экраны владельца | [back/001](back/001-api-skeleton/), [front/guest/001](front/guest/001-client-foundation/), [front/ui/003](front/ui/003-owner-uispec-sync/) | реализация (21/22) |
...
|---|---|---|---|
| [front/owner/001](front/owner/001-owner-screens/) | реализация (21/22) | Экраны владельца по синхронизированным спекам; приоритет перед back/002–003 — решение владельца 2026-08-17 | — |
