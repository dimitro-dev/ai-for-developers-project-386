...
| [back/002](back/002-database-persistence/) | Персистентность: схема БД, миграции и exclusion constraint | [infra/001](infra/001-postgres-compose/) | реализация (0/10) |
...
| [back/002](back/002-database-persistence/) | реализация (0/10) | Схема БД, миграции и exclusion constraint — последняя линия защиты от пересечения Booking, недостижимая на in-memory | — |
