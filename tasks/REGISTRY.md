...
| id | Задача | Зависимости | Стадия |
|---|---|---|---|
| [process/001](process/001-tasks-rework/) | Переработка процесса задач: структура, стадии, CLI | — | результат (23/23) |
...
| [process/001](process/001-tasks-rework/) | результат (23/23) | Активная задача: инструмент task, треки full/lite, миграция каталога, растворение ролей | — |
