...
1. Описать модели owner setup/calendar settings, availability, Event Type, Slot, Booking и GuestDetails.
...
- [`../../agents/contract-agent.md`](../../agents/contract-agent.md)
- [`../task-001/`](../task-001/)
